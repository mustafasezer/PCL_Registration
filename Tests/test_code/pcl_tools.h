...
public:
    ...
    pcl::PointCloud<PointT>::Ptr getSlice(pcl::PointCloud<PointT>::Ptr cloud, float z1, float z2, bool neg, std::string field_name = "z");
    ...
    float MAX_CORRESPONDENCE_INIT;
    float MAX_CORRESPONDENCE_STEP;
