...
Eigen::Matrix4f pcl_tools::pairAlign (const PointCloud::Ptr cloud_src, const PointCloud::Ptr cloud_tgt, bool downsample)
{
    ...
    for (int i = 0; i < MAX_CORRESPONDENCE_INIT/MAX_CORRESPONDENCE_STEP; ++i)
    {
...
pcl::PointCloud<PointT>::Ptr pcl_tools::getSlice(pcl::PointCloud<PointT>::Ptr cloud, float z1, float z2, bool neg, string field_name){
    pcl::PointCloud<PointT>::Ptr cloud_filtered (new pcl::PointCloud<PointT>);
    pcl::PassThrough<PointT> pass;
    pass.setInputCloud (cloud);
    pass.setFilterFieldName (field_name);
    pass.setFilterLimits (z1, z2);
    pass.setFilterLimitsNegative (neg);
